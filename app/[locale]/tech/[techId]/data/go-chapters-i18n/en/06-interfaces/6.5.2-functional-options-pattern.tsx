...
export default function FunctionalOptionsPattern({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">6.5.2 Functional Options Pattern</h3>
      <p>Using interfaces to implement flexible configuration.</p>
