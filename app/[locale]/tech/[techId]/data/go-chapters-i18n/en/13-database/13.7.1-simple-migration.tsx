...
export default function SimpleMigrationSystem({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">13.7.1 Simple Migration System</h3>
...
func migrateDown(db *sql.DB, steps int) error {
    ...
    return nil
      ...
      <p>## 13.8 Practical Project: User Management System</p>
