...
export default function UseSqlNullTypes({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">13.6.1 Use sql.Null Types</h3>
...
type UserProfile struct {
    ID       int
    Username string
    Bio      sql.NullString  // Nullable string
