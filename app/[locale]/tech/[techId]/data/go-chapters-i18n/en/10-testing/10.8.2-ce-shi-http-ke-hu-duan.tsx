...
export default function TestingHttpClient({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">10.8.2 Testing HTTP Client</h3>
...
func TestFetchURL(t *testing.T) {
    ...
    if content != expected {
      ...
      <p>## 10.9 Practice: Complete User Service Testing</p>
