...
export default function DataModelModelsusergo({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">15.1.3 Data Model (models/user.go)</h3>
...
export const metadata = {
  id: '15-1-3',
  title: 'Data Model (models/user.go)',
  section: '15.1.3'
};
