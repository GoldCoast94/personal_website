...
export default function TodoHandlerHandlerstodogo({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">15.1.11 Todo Handler (handlers/todo.go)</h3>
...
export const metadata = {
  id: '15-1-11',
  title: 'Todo Handler (handlers/todo.go)',
  section: '15.1.11'
};
