...
export default function JwtUtilityUtilsjwtgo({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">15.1.6 JWT Utility (utils/jwt.go)</h3>
...
export const metadata = {
  id: '15-1-6',
  title: 'JWT Utility (utils/jwt.go)',
  section: '15.1.6'
};
