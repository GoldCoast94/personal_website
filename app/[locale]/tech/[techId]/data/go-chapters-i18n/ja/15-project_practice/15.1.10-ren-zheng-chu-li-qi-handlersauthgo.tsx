...
export default function 認証ハンドラHandlersauthgo({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">15.1.10 認証ハンドラ (handlers/auth.go)</h3>
