...
export default function レスポンスユーティリティUtilsresponsego({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">15.1.7 レスポンスユーティリティ (utils/response.go)</h3>
...
export const metadata = {
  id: '15-1-7',
  title: 'レスポンスユーティリティ (utils/response.go)',
  section: '15.1.7'
};
