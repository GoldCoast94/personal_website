...
export default function シンプルマイグレーションシステム({ className }: Props) {
  return (
    <div className={`section-content ${className || ''}`}>
      <h3 className="section-title">13.7.1 シンプルマイグレーションシステム</h3>
